...
class TestCmdConfig:
    ...
    def test_show_config(self, tmp_path, capsys):
        ...
        with patch("slopbucket.sb.ensure_checks_registered"):
            with patch("slopbucket.sb.get_registry") as mock_registry:
                mock_reg = MagicMock()
...
class TestGitHooksFunctions:
    ...
    def test_generate_hook_script(self):
        ...
        assert "sb validate commit" in script
...
class TestCmdCommitHooks:
    ...
    def test_install_hook(self, tmp_path, capsys):
        ...
        assert "sb validate commit" in hook_file.read_text()
...
class TestMain:
    ...
    def test_main_validate_calls_cmd_validate(self):
        ...
        with patch("slopbucket.sb.cmd_validate") as mock_cmd:
    ...
    def test_main_config_calls_cmd_config(self):
        ...
        with patch("slopbucket.sb.cmd_config") as mock_cmd:
            mock_cmd.return_value = 0
    ...
    def test_main_help_calls_cmd_help(self):
        ...
        with patch("slopbucket.sb.cmd_help") as mock_cmd:
            mock_cmd.return_value = 0
            result = main(["help"])
            mock_cmd.assert_called_once()
            assert result == 0
    ...
    def test_main_commit_hooks_calls_cmd_commit_hooks(self):
        ...
        with patch("slopbucket.sb.cmd_commit_hooks") as mock_cmd:
            mock_cmd.return_value = 0
