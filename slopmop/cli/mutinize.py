...
def _generate_aliases_sh(version: str) -> bytes:
    ...
    lines: list[str] = [
        ...
        "#",
        "# To remove ALL intercepts without relying on 'sm mutinize uninstall':",
        "#   sed -i.bak '/# BEGIN sm-mutinize/,/# END sm-mutinize/d' ~/.zshrc",
...
def _show_confirm_warning() -> None:
    ...
    print("  • To remove: sm mutinize uninstall")
