...
def _gang_status() -> int:
    ...
    if _ALIASES_DEST.exists():
        ...
        print(f"  ✗  aliases.sh not installed (run: sm gang install)")
    ...
    if wired_legacy:
        ...
        print("      Run: sm gang uninstall && sm gang install to migrate")
    ...
    print()
    print("Commands:")
    print("  sm gang install    # install (requires --confirm)")
    print("  sm gang uninstall  # remove all artifacts")
...
def cmd_gang(args: argparse.Namespace) -> int:
    ...
    if action == "install":
        return _gang_install(confirm=getattr(args, "confirm", ""))
    elif action == "uninstall":
        return _gang_uninstall()
    elif action == "status":
        return _gang_status()
    elif action == "list":
        return _gang_list()
