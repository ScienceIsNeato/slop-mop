...
This module implements the IaC (Infrastructure as Code) pattern for slopbucket
...
Usage:
    python -m slopbucket.utils.generate_base_config [output_path]
"""
...
from slopbucket.core.config import CONFIG_FILE
