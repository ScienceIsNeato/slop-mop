"""Configuration management for slopbucket quality gates.
...
@dataclass
class SlopbucketConfig:
    """Top-level slopbucket configuration."""
    ...
    @classmethod
    def load(cls, project_root: str) -> "SlopbucketConfig":
        ...
        Returns:
            SlopbucketConfig instance (empty defaults if no config file)
        """
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "SlopbucketConfig":
...
def validate_include_dirs(
    ...
    if not include_dirs:
        ...
        raise ConfigError(
            ...
            fix_suggestion=(
                f'Run "sb init" to configure, or add to .sb_config.json:\n'
