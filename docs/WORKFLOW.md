...
|---|---|---|---|---|
| 1 — fix first (structural) | `deceptiveness:bogus-tests.dart` | Diagnostic | 🎭 Deceptiveness | no |
| 1 — fix first (structural) | `deceptiveness:bogus-tests.js` | Diagnostic | 🎭 Deceptiveness | no |
| 1 — fix first (structural) | `deceptiveness:bogus-tests.py` | Diagnostic | 🎭 Deceptiveness | no |
| 1 — fix first (structural) | `deceptiveness:gate-dodging` | Diagnostic | 🎭 Deceptiveness | no |
| 1 — fix first (structural) | `deceptiveness:hand-wavy-tests.js` | Foundation | 🎭 Deceptiveness | no |
| 1 — fix first (structural) | `laziness:complexity-creep.py` | Foundation | 🦥 Laziness | no |
| 1 — fix first (structural) | `laziness:dead-code.py` | Foundation | 🦥 Laziness | no |
| 1 — fix first (structural) | `laziness:silenced-gates` | Diagnostic | 🦥 Laziness | no |
| 1 — fix first (structural) | `myopia:code-sprawl` | Diagnostic | 👓 Myopia | no |
| 1 — fix first (structural) | `myopia:source-duplication` | Foundation | 👓 Myopia | no |
| 1 — fix first (structural) | `overconfidence:coverage-gaps.dart` | Foundation | 💯 Overconfidence | no |
| 1 — fix first (structural) | `overconfidence:coverage-gaps.js` | Foundation | 💯 Overconfidence | no |
| 1 — fix first (structural) | `overconfidence:coverage-gaps.py` | Foundation | 💯 Overconfidence | no |
| 2 — fix next (additive) | `laziness:broken-templates.py` | Foundation | 💯 Overconfidence | no |
| 2 — fix next (additive) | `laziness:sloppy-frontend.js` | Foundation | 🦥 Laziness | no |
| 2 — fix next (additive) | `myopia:string-duplication.py` | Diagnostic | 👓 Myopia | no |
| 2 — fix next (additive) | `myopia:vulnerability-blindness.py` | Foundation | 👓 Myopia | no |
| 2 — fix next (additive) | `overconfidence:missing-annotations.py` | Foundation | 💯 Overconfidence | no |
| 2 — fix next (additive) | `overconfidence:type-blindness.js` | Foundation | 💯 Overconfidence | no |
| 2 — fix next (additive) | `overconfidence:type-blindness.py` | Foundation | 💯 Overconfidence | no |
| 2 — fix next (additive) | `overconfidence:untested-code.js` | Foundation | 💯 Overconfidence | no |
| 2 — fix next (additive) | `overconfidence:untested-code.py` | Foundation | 💯 Overconfidence | no |
| 3 — fix last (cosmetic) | `deceptiveness:debugger-artifacts` | Diagnostic | 🎭 Deceptiveness | no |
| 3 — fix last (cosmetic) | `laziness:generated-artifacts.dart` | Diagnostic | 🦥 Laziness | no |
| 3 — fix last (cosmetic) | `laziness:sloppy-formatting.js` | Foundation | 🦥 Laziness | yes |
| 3 — fix last (cosmetic) | `laziness:sloppy-formatting.py` | Foundation | 🦥 Laziness | yes |
