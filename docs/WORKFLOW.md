...
| 2 — fix next (behavioral) | `deceptiveness:bogus-tests.dart` | Diagnostic | 🎭 Deceptiveness | no |
| 2 — fix next (behavioral) | `deceptiveness:bogus-tests.js` | Diagnostic | 🎭 Deceptiveness | no |
| 2 — fix next (behavioral) | `deceptiveness:bogus-tests.py` | Diagnostic | 🎭 Deceptiveness | no |
| 2 — fix next (behavioral) | `deceptiveness:gate-dodging` | Diagnostic | 🎭 Deceptiveness | no |
| 2 — fix next (behavioral) | `deceptiveness:hand-wavy-tests.js` | Foundation | 🎭 Deceptiveness | no |
| 2 — fix next (behavioral) | `laziness:silenced-gates` | Diagnostic | 🦥 Laziness | no |
| 3 — fix next (additive) | `laziness:broken-templates.py` | Foundation | 💯 Overconfidence | no |
| 3 — fix next (additive) | `laziness:sloppy-frontend.js` | Foundation | 🦥 Laziness | no |
| 3 — fix next (additive) | `myopia:string-duplication.py` | Diagnostic | 👓 Myopia | no |
| 3 — fix next (additive) | `myopia:vulnerability-blindness.py` | Foundation | 👓 Myopia | no |
| 3 — fix next (additive) | `overconfidence:coverage-gaps.dart` | Foundation | 💯 Overconfidence | no |
| 3 — fix next (additive) | `overconfidence:coverage-gaps.js` | Foundation | 💯 Overconfidence | no |
| 3 — fix next (additive) | `overconfidence:coverage-gaps.py` | Foundation | 💯 Overconfidence | no |
| 3 — fix next (additive) | `overconfidence:missing-annotations.py` | Foundation | 💯 Overconfidence | no |
| 3 — fix next (additive) | `overconfidence:type-blindness.js` | Foundation | 💯 Overconfidence | no |
| 3 — fix next (additive) | `overconfidence:type-blindness.py` | Foundation | 💯 Overconfidence | no |
| 3 — fix next (additive) | `overconfidence:untested-code.js` | Foundation | 💯 Overconfidence | no |
| 3 — fix next (additive) | `overconfidence:untested-code.py` | Foundation | 💯 Overconfidence | no |
| 4 — fix later (cosmetic) | `deceptiveness:debugger-artifacts` | Diagnostic | 🎭 Deceptiveness | no |
| 4 — fix later (cosmetic) | `laziness:sloppy-formatting.js` | Foundation | 🦥 Laziness | yes |
| 4 — fix later (cosmetic) | `laziness:sloppy-formatting.py` | Foundation | 🦥 Laziness | yes |
| 5 — fix last (metadata) | `laziness:generated-artifacts.dart` | Diagnostic | 🦥 Laziness | no |
