...
name: sm-buff
description: >-
  Triage CI results and PR review threads after pushing. Use instead of
  gh pr checks, gh run view, gh run watch, or reading CI logs. Triggers
...
- **NEVER** run raw `gh pr checks`, `gh run view`, or read CI logs
